        ...
        <nav>
          ...
          >
            ...
            <div className="nav-container">
                ...
                // placeholder="Enter your search cars"
                placeholder="Search"
                value={searchQuery}
                onChange={handleInputChange}
                />
                <button className="btns" type="submit" onClick={handleSearchClick}>Search</button>
                <button className="btns icon" onClick={handleSearchClick}>
